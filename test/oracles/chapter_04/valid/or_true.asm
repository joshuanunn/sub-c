   ...
   [Asm.Function {name = "main"; global = true;
      ...
      [(Asm.AllocateStack 32); (Asm.Jmp "main.or.tr.1");
        ...
        Asm.Binary {op = Asm.Add; src = (Asm.Reg Asm.R10);
          dst = (Asm.Stack -12)};
        (Asm.Jmp "main.or.tr.8"); (Asm.Jmp "main.or.tr.8");
        (Asm.Mov ((Asm.Imm 0), (Asm.Stack -16))); (Asm.Jmp "main.or.en.9");
        (Asm.Label "main.or.tr.8"); (Asm.Mov ((Asm.Imm 1), (Asm.Stack -16)));
        (Asm.Label "main.or.en.9");
