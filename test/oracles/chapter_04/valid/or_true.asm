(Asm.Program
   Asm.Function {name = "main";
     ...
     [(Asm.AllocateStack 20); (Asm.Mov ((Asm.Imm 4), (Asm.Reg Asm.R11)));
       ...
       (Asm.Label "or_end.2"); (Asm.Mov ((Asm.Imm 0), (Asm.Reg Asm.R11)));
       (Asm.Cmp ((Asm.Imm 0), (Asm.Reg Asm.R11)));
       ...
       (Asm.Label "or_end.5"); (Asm.Mov ((Asm.Stack -4), (Asm.Reg Asm.R10)));
       ...
       (Asm.Cmp ((Asm.Imm 0), (Asm.Reg Asm.R11)));
       (Asm.JmpCC (Asm.NE, "or_true.8"));
       (Asm.Mov ((Asm.Imm 5), (Asm.Reg Asm.R11)));
       (Asm.Cmp ((Asm.Imm 0), (Asm.Reg Asm.R11)));
       (Asm.JmpCC (Asm.NE, "or_true.8"));
       (Asm.Mov ((Asm.Imm 0), (Asm.Stack -16))); (Asm.Jmp "or_end.9");
       (Asm.Label "or_true.8"); (Asm.Mov ((Asm.Imm 1), (Asm.Stack -16)));
       (Asm.Label "or_end.9");
