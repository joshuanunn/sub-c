(Asm.Program
   [Asm.Function {name = "main"; global = true;
      ...
      [(Asm.AllocateStack 144); (Asm.Mov ((Asm.Imm 250), (Asm.Stack -4)));
        ...
        (Asm.JmpCC (Asm.E, "and.fl.10"));
        (Asm.Mov ((Asm.Imm 1), (Asm.Stack -80))); (Asm.Jmp "and.en.11");
        (Asm.Label "and.fl.10"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -80)));
        (Asm.Label "and.en.11"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -80)));
        (Asm.JmpCC (Asm.E, "and.fl.14"));
        (Asm.Cmp ((Asm.Imm 109), (Asm.Stack -12)));
        (Asm.Mov ((Asm.Imm 0), (Asm.Stack -84)));
        (Asm.SetCC (Asm.E, (Asm.Stack -84)));
        (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -84)));
        (Asm.JmpCC (Asm.E, "and.fl.14"));
        (Asm.Mov ((Asm.Imm 1), (Asm.Stack -88))); (Asm.Jmp "and.en.15");
        (Asm.Label "and.fl.14"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -88)));
        (Asm.Label "and.en.15"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -88)));
        ...
        (Asm.JmpCC (Asm.E, "and.fl.18"));
        (Asm.Mov ((Asm.Imm 1), (Asm.Stack -96))); (Asm.Jmp "and.en.19");
        (Asm.Label "and.fl.18"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -96)));
        (Asm.Label "and.en.19"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -96)));
        ...
        (Asm.JmpCC (Asm.E, "and.fl.22"));
        (Asm.Mov ((Asm.Imm 1), (Asm.Stack -104))); (Asm.Jmp "and.en.23");
        (Asm.Label "and.fl.22"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -104)));
        (Asm.Label "and.en.23"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -104)));
        ...
        (Asm.JmpCC (Asm.E, "and.fl.26"));
        (Asm.Mov ((Asm.Imm 1), (Asm.Stack -112))); (Asm.Jmp "and.en.27");
        (Asm.Label "and.fl.26"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -112)));
        (Asm.Label "and.en.27"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -112)));
        ...
        (Asm.JmpCC (Asm.E, "and.fl.30"));
        (Asm.Mov ((Asm.Imm 1), (Asm.Stack -120))); (Asm.Jmp "and.en.31");
        (Asm.Label "and.fl.30"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -120)));
        (Asm.Label "and.en.31"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -120)));
        ...
        (Asm.JmpCC (Asm.E, "and.fl.34"));
        (Asm.Mov ((Asm.Imm 1), (Asm.Stack -128))); (Asm.Jmp "and.en.35");
        (Asm.Label "and.fl.34"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -128)));
        (Asm.Label "and.en.35"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -128)));
        (Asm.JmpCC (Asm.E, "and.fl.38"));
        ...
        (Asm.JmpCC (Asm.E, "and.fl.38"));
        (Asm.Mov ((Asm.Imm 1), (Asm.Stack -136))); (Asm.Jmp "and.en.39");
        (Asm.Label "and.fl.38"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -136)));
        (Asm.Label "and.en.39"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -136)));
        (Asm.JmpCC (Asm.E, "and.fl.42"));
        ...
        (Asm.JmpCC (Asm.E, "and.fl.42"));
        (Asm.Mov ((Asm.Imm 1), (Asm.Stack -144))); (Asm.Jmp "and.en.43");
        (Asm.Label "and.fl.42"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -144)));
        (Asm.Label "and.en.43");
