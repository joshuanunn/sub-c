(Asm.Program
   Asm.Function {name = "main";
     ...
     [(Asm.AllocateStack 144); (Asm.Mov ((Asm.Imm 250), (Asm.Stack -4)));
       ...
       (Asm.JmpCC (Asm.E, "and_false.20"));
       (Asm.Mov ((Asm.Imm 1), (Asm.Stack -80))); (Asm.Jmp "and_end.21");
       (Asm.Label "and_false.20"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -80)));
       (Asm.Label "and_end.21"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -80)));
       ...
       (Asm.JmpCC (Asm.E, "and_false.24"));
       (Asm.Mov ((Asm.Imm 1), (Asm.Stack -88))); (Asm.Jmp "and_end.25");
       (Asm.Label "and_false.24"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -88)));
       (Asm.Label "and_end.25"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -88)));
       ...
       (Asm.JmpCC (Asm.E, "and_false.28"));
       (Asm.Mov ((Asm.Imm 1), (Asm.Stack -96))); (Asm.Jmp "and_end.29");
       (Asm.Label "and_false.28"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -96)));
       (Asm.Label "and_end.29"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -96)));
       ...
       (Asm.JmpCC (Asm.E, "and_false.36"));
       (Asm.Mov ((Asm.Imm 1), (Asm.Stack -112))); (Asm.Jmp "and_end.37");
       (Asm.Label "and_false.36"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -112)));
       (Asm.Label "and_end.37"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -112)));
       ...
       (Asm.JmpCC (Asm.E, "and_false.40"));
       (Asm.Mov ((Asm.Imm 1), (Asm.Stack -120))); (Asm.Jmp "and_end.41");
       (Asm.Label "and_false.40"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -120)));
       (Asm.Label "and_end.41"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -120)));
       ...
       (Asm.JmpCC (Asm.E, "and_false.44"));
       (Asm.Mov ((Asm.Imm 1), (Asm.Stack -128))); (Asm.Jmp "and_end.45");
       (Asm.Label "and_false.44"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -128)));
       (Asm.Label "and_end.45"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -128)));
       ...
       (Asm.JmpCC (Asm.E, "and_false.48"));
       (Asm.Mov ((Asm.Imm 1), (Asm.Stack -136))); (Asm.Jmp "and_end.49");
       (Asm.Label "and_false.48"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -136)));
       (Asm.Label "and_end.49"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -136)));
       ...
       (Asm.JmpCC (Asm.E, "and_false.52"));
       (Asm.Mov ((Asm.Imm 1), (Asm.Stack -144))); (Asm.Jmp "and_end.53");
       (Asm.Label "and_false.52"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -144)));
