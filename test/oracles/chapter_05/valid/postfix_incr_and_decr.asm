(Asm.Program
   Asm.Function {name = "main";
     ...
     [(Asm.AllocateStack 52); (Asm.Mov ((Asm.Imm 1), (Asm.Stack -4)));
       ...
       (Asm.Label "and_end.14"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -44)));
       ...
       (Asm.JmpCC (Asm.E, "and_false.17"));
       (Asm.Mov ((Asm.Imm 1), (Asm.Stack -52))); (Asm.Jmp "and_end.18");
       (Asm.Label "and_false.17"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -52)));
