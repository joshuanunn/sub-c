(Asm.Program
   Asm.Function {name = "main";
     ...
     [(Asm.AllocateStack 76); (Asm.Mov ((Asm.Imm 10), (Asm.Stack -4)));
       ...
       (Asm.Label "and_end.20"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -60)));
       ...
       (Asm.JmpCC (Asm.E, "and_false.23"));
       (Asm.Mov ((Asm.Imm 1), (Asm.Stack -68))); (Asm.Jmp "and_end.24");
       (Asm.Label "and_false.23"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -68)));
       (Asm.Label "and_end.24"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -68)));
       ...
       (Asm.JmpCC (Asm.E, "and_false.27"));
       (Asm.Mov ((Asm.Imm 1), (Asm.Stack -76))); (Asm.Jmp "and_end.28");
       (Asm.Label "and_false.27"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -76)));
       (Asm.Label "and_end.28");
