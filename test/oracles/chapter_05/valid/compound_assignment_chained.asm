(Asm.Program
   Asm.Function {name = "main";
     ...
     [(Asm.AllocateStack 124); (Asm.Mov ((Asm.Imm 250), (Asm.Stack -4)));
       ...
       (Asm.JmpCC (Asm.E, "and_false.10"));
       (Asm.Mov ((Asm.Imm 1), (Asm.Stack -68))); (Asm.Jmp "and_end.11");
       (Asm.Label "and_false.10"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -68)));
       (Asm.Label "and_end.11"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -68)));
       ...
       (Asm.JmpCC (Asm.E, "and_false.15"));
       (Asm.Mov ((Asm.Imm 1), (Asm.Stack -80))); (Asm.Jmp "and_end.16");
       (Asm.Label "and_false.15"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -80)));
       (Asm.Label "and_end.16"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -80)));
       ...
       (Asm.JmpCC (Asm.E, "and_false.20"));
       (Asm.Mov ((Asm.Imm 1), (Asm.Stack -92))); (Asm.Jmp "and_end.21");
       (Asm.Label "and_false.20"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -92)));
       (Asm.Label "and_end.21"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -92)));
       (Asm.JmpCC (Asm.E, "and_false.25"));
       ...
       (Asm.JmpCC (Asm.E, "and_false.25"));
       (Asm.Mov ((Asm.Imm 1), (Asm.Stack -104))); (Asm.Jmp "and_end.26");
       (Asm.Label "and_false.25"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -104)));
       (Asm.Label "and_end.26"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -104)));
       ...
       (Asm.JmpCC (Asm.E, "and_false.30"));
       (Asm.Mov ((Asm.Imm 1), (Asm.Stack -116))); (Asm.Jmp "and_end.31");
       (Asm.Label "and_false.30"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -116)));
       (Asm.Label "and_end.31"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -116)));
       ...
       (Asm.JmpCC (Asm.E, "and_false.34"));
       (Asm.Mov ((Asm.Imm 1), (Asm.Stack -124))); (Asm.Jmp "and_end.35");
       (Asm.Label "and_false.34"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -124)));
       (Asm.Label "and_end.35");
