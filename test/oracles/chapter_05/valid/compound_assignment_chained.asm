(Asm.Program
   [Asm.Function {name = "main"; global = true;
      ...
      [(Asm.AllocateStack 128); (Asm.Mov ((Asm.Imm 250), (Asm.Stack -4)));
        ...
        (Asm.JmpCC (Asm.E, "and.fl.10"));
        (Asm.Mov ((Asm.Imm 1), (Asm.Stack -68))); (Asm.Jmp "and.en.11");
        ...
        (Asm.JmpCC (Asm.E, "and.fl.15"));
        (Asm.Mov ((Asm.Imm 1), (Asm.Stack -80))); (Asm.Jmp "and.en.16");
        ...
        (Asm.JmpCC (Asm.E, "and.fl.20"));
        (Asm.Mov ((Asm.Imm 1), (Asm.Stack -92))); (Asm.Jmp "and.en.21");
        ...
        (Asm.JmpCC (Asm.E, "and.fl.25"));
        (Asm.Mov ((Asm.Imm 1), (Asm.Stack -104))); (Asm.Jmp "and.en.26");
        ...
        (Asm.JmpCC (Asm.E, "and.fl.30"));
        (Asm.Mov ((Asm.Imm 1), (Asm.Stack -116))); (Asm.Jmp "and.en.31");
        (Asm.Label "and.fl.30"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -116)));
        (Asm.Label "and.en.31"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -116)));
        ...
        (Asm.JmpCC (Asm.E, "and.fl.34"));
        (Asm.Mov ((Asm.Imm 1), (Asm.Stack -124))); (Asm.Jmp "and.en.35");
        (Asm.Label "and.fl.34"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -124)));
        (Asm.Label "and.en.35");
