(Asm.Program
   Asm.Function {name = "main";
     ...
     [(Asm.AllocateStack 44); (Asm.Mov ((Asm.Imm 1), (Asm.Stack -4)));
       ...
       (Asm.Label "and_end.8"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -28)));
       ...
       (Asm.JmpCC (Asm.E, "and_false.11"));
       (Asm.Mov ((Asm.Imm 1), (Asm.Stack -36))); (Asm.Jmp "and_end.12");
       (Asm.Label "and_false.11"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -36)));
       (Asm.Label "and_end.12"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -36)));
       ...
       (Asm.JmpCC (Asm.E, "and_false.15"));
       (Asm.Mov ((Asm.Imm 1), (Asm.Stack -44))); (Asm.Jmp "and_end.16");
       (Asm.Label "and_false.15"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -44)));
