(Asm.Program
   Asm.Function {name = "main";
     ...
     [(Asm.AllocateStack 96); (Asm.Mov ((Asm.Imm 11), (Asm.Stack -4)));
       ...
       (Asm.JmpCC (Asm.NE, "or_true.1"));
       (Asm.Mov ((Asm.Imm 0), (Asm.Stack -12))); (Asm.Jmp "or_end.2");
       (Asm.Label "or_true.1"); (Asm.Mov ((Asm.Imm 1), (Asm.Stack -12)));
       (Asm.Label "or_end.2"); (Asm.Mov ((Asm.Stack -4), (Asm.Reg Asm.R10)));
       ...
       (Asm.Label "or_end.6"); (Asm.Mov ((Asm.Stack -8), (Asm.Reg Asm.R10)));
       ...
       (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -4)));
       (Asm.JmpCC (Asm.NE, "or_true.9"));
       (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -8)));
       (Asm.JmpCC (Asm.NE, "or_true.9"));
       (Asm.Mov ((Asm.Imm 0), (Asm.Stack -32))); (Asm.Jmp "or_end.10");
       (Asm.Label "or_true.9"); (Asm.Mov ((Asm.Imm 1), (Asm.Stack -32)));
       (Asm.Label "or_end.10");
       ...
       (Asm.JmpCC (Asm.NE, "or_true.13"));
       (Asm.Mov ((Asm.Imm 0), (Asm.Stack -44))); (Asm.Jmp "or_end.14");
       (Asm.Label "or_true.13"); (Asm.Mov ((Asm.Imm 1), (Asm.Stack -44)));
       (Asm.Label "or_end.14");
       ...
       (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -40)));
       (Asm.JmpCC (Asm.NE, "or_true.17"));
       (Asm.Mov ((Asm.Imm 0), (Asm.Stack -56))); (Asm.Jmp "or_end.18");
       (Asm.Label "or_true.17"); (Asm.Mov ((Asm.Imm 1), (Asm.Stack -56)));
       (Asm.Label "or_end.18");
       ...
       (Asm.JmpCC (Asm.E, "and_false.23"));
       (Asm.Mov ((Asm.Imm 1), (Asm.Stack -72))); (Asm.Jmp "and_end.24");
       (Asm.Label "and_false.23"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -72)));
       (Asm.Label "and_end.24"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -72)));
       ...
       (Asm.JmpCC (Asm.E, "and_false.27"));
       (Asm.Mov ((Asm.Imm 1), (Asm.Stack -80))); (Asm.Jmp "and_end.28");
       (Asm.Label "and_false.27"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -80)));
       (Asm.Label "and_end.28"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -80)));
       ...
       (Asm.JmpCC (Asm.E, "and_false.31"));
       (Asm.Mov ((Asm.Imm 1), (Asm.Stack -88))); (Asm.Jmp "and_end.32");
       (Asm.Label "and_false.31"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -88)));
       (Asm.Label "and_end.32"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -88)));
       (Asm.JmpCC (Asm.E, "and_false.35"));
       (Asm.Cmp ((Asm.Imm 36), (Asm.Stack -52)));
       (Asm.Mov ((Asm.Imm 0), (Asm.Stack -92)));
       (Asm.SetCC (Asm.E, (Asm.Stack -92)));
       (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -92)));
       (Asm.JmpCC (Asm.E, "and_false.35"));
       (Asm.Mov ((Asm.Imm 1), (Asm.Stack -96))); (Asm.Jmp "and_end.36");
       (Asm.Label "and_false.35"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -96)));
       (Asm.Label "and_end.36");
