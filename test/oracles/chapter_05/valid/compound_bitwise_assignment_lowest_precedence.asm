(Asm.Program
   [Asm.Function {name = "main"; global = true;
      ...
      [(Asm.AllocateStack 96); (Asm.Mov ((Asm.Imm 11), (Asm.Stack -4)));
        ...
        (Asm.Mov ((Asm.Imm 11), (Asm.Stack -16)));
        ...
        (Asm.Mov ((Asm.Imm 16), (Asm.Stack -48)));
        ...
        (Asm.Mov ((Asm.Imm 18), (Asm.Stack -60)));
        ...
        (Asm.Cmp ((Asm.Imm 13), (Asm.Stack -24)));
        ...
        (Asm.Cmp ((Asm.Imm 15), (Asm.Stack -36)));
