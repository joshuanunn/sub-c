(Asm.Program
   [Asm.Function {name = "main"; global = true;
      ...
      [(Asm.AllocateStack 64); (Asm.Mov ((Asm.Imm 1), (Asm.Stack -4)));
        ...
        (Asm.JmpCC (Asm.E, "main.and.fl.6"));
        (Asm.Mov ((Asm.Imm 1), (Asm.Stack -40))); (Asm.Jmp "main.and.en.7");
        ...
        (Asm.JmpCC (Asm.E, "main.and.fl.11"));
        (Asm.Mov ((Asm.Imm 1), (Asm.Stack -52))); (Asm.Jmp "main.and.en.12");
        ...
        (Asm.JmpCC (Asm.E, "main.and.fl.15"));
        (Asm.Mov ((Asm.Imm 1), (Asm.Stack -60))); (Asm.Jmp "main.and.en.16");
