(Asm.Program
   Asm.Function {name = "main";
     ...
     [(Asm.AllocateStack 60); (Asm.Mov ((Asm.Imm 1), (Asm.Stack -4)));
       ...
       (Asm.Label "and_end.7"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -40)));
       ...
       (Asm.JmpCC (Asm.E, "and_false.11"));
       (Asm.Mov ((Asm.Imm 1), (Asm.Stack -52))); (Asm.Jmp "and_end.12");
       (Asm.Label "and_false.11"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -52)));
       (Asm.Label "and_end.12"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -52)));
       ...
       (Asm.JmpCC (Asm.E, "and_false.15"));
       (Asm.Mov ((Asm.Imm 1), (Asm.Stack -60))); (Asm.Jmp "and_end.16");
       (Asm.Label "and_false.15"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -60)));
