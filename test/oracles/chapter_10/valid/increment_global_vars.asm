   ...
   [Asm.Function {name = "incr_i"; global = true;
     ...
     Asm.Function {name = "main"; global = true;
       ...
       [(Asm.AllocateStack 32);
         ...
         (Asm.Mov ((Asm.Imm 0), (Asm.Stack -4))); (Asm.Jmp "cond.en.2");
         (Asm.Label "cond.el.3"); (Asm.Call "incr_i");
         (Asm.Mov ((Asm.Reg Asm.AX), (Asm.Stack -12)));
         (Asm.Mov ((Asm.Stack -12), (Asm.Reg Asm.R10)));
         (Asm.Mov ((Asm.Reg Asm.R10), (Asm.Stack -4)));
         (Asm.Label "cond.en.2"); (Asm.Cmp ((Asm.Imm 3), (Asm.Data "i")));
         ...
         (Asm.JmpCC (Asm.E, "cond.el.9")); (Asm.Call "decr_j");
