(Asm.Program
   Asm.Function {name = "main";
     ...
     [(Asm.AllocateStack 56); (Asm.Mov ((Asm.Imm 10), (Asm.Stack -4)));
       ...
       (Asm.JmpCC (Asm.E, "and_false.11"));
       (Asm.Mov ((Asm.Imm 1), (Asm.Stack -48))); (Asm.Jmp "and_end.12");
       (Asm.Label "and_false.11"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -48)));
       (Asm.Label "and_end.12"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -48)));
       ...
       (Asm.JmpCC (Asm.E, "and_false.15"));
       (Asm.Mov ((Asm.Imm 1), (Asm.Stack -56))); (Asm.Jmp "and_end.16");
       (Asm.Label "and_false.15"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -56)));
