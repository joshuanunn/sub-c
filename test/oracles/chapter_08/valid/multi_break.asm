(Asm.Program
   Asm.Function {name = "main";
     ...
     [(Asm.AllocateStack 44); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -4)));
       ...
       (Asm.Label "if.en.2"); (Asm.Jmp "loop.ct.1"); (Asm.Label "loop.br.1");
       (Asm.Mov ((Asm.Imm 10), (Asm.Stack -16))); (Asm.Label "loop.ct.2");
       ...
       (Asm.Label "if.en.5"); (Asm.Jmp "loop.ct.2"); (Asm.Label "loop.br.2");
