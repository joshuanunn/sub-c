(Asm.Program
   Asm.Function {name = "main";
     ...
     [(Asm.AllocateStack 56); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -4)));
       ...
       (Asm.JmpCC (Asm.E, "and_false.6"));
       (Asm.Mov ((Asm.Imm 1), (Asm.Stack -48))); (Asm.Jmp "and_end.7");
       (Asm.Label "and_false.6"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -48)));
       (Asm.Label "and_end.7"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -48)));
