(Asm.Program
   [Asm.Function {name = "main"; global = true;
      instructions =
      [(Asm.AllocateStack 32); (Asm.Mov ((Asm.Imm 1), (Asm.Reg Asm.R11)));
        (Asm.Cmp ((Asm.Imm 0), (Asm.Reg Asm.R11)));
        (Asm.JmpCC (Asm.E, "cond.el.2"));
        (Asm.Mov ((Asm.Imm 2), (Asm.Reg Asm.R11)));
        (Asm.Cmp ((Asm.Imm 0), (Asm.Reg Asm.R11)));
        (Asm.JmpCC (Asm.E, "cond.el.5"));
        (Asm.Mov ((Asm.Imm 3), (Asm.Stack -12))); (Asm.Jmp "cond.en.4");
        (Asm.Label "cond.el.5"); (Asm.Mov ((Asm.Imm 4), (Asm.Stack -12)));
        (Asm.Label "cond.en.4");
        ...
        (Asm.Cmp ((Asm.Imm 0), (Asm.Reg Asm.R11)));
        (Asm.JmpCC (Asm.E, "cond.el.8"));
        (Asm.Mov ((Asm.Imm 2), (Asm.Reg Asm.R11)));
        (Asm.Cmp ((Asm.Imm 0), (Asm.Reg Asm.R11)));
        (Asm.JmpCC (Asm.E, "cond.el.11"));
