(Asm.Program
   Asm.Function {name = "main";
     ...
     [(Asm.AllocateStack 24); (Asm.Mov ((Asm.Imm 10), (Asm.Stack -4)));
       ...
       (Asm.Label "cond.el.2"); (Asm.Mov ((Asm.Imm 2), (Asm.Stack -12)));
       (Asm.Label "cond.en.1");
       ...
       (Asm.JmpCC (Asm.E, "and.fl.6"));
       (Asm.Mov ((Asm.Imm 1), (Asm.Stack -24))); (Asm.Jmp "and.en.7");
       (Asm.Label "and.fl.6"); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -24)));
       (Asm.Label "and.en.7"); (Asm.Mov ((Asm.Stack -24), (Asm.Reg Asm.AX)));
