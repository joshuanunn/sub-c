(Asm.Program
   Asm.Function {name = "main";
     ...
     [(Asm.AllocateStack 24); (Asm.Mov ((Asm.Imm 1), (Asm.Stack -4)));
       ...
       (Asm.Mov ((Asm.Imm 5), (Asm.Stack -16))); (Asm.Jmp "cond_end.2");
       (Asm.Label "cond_e2.3"); (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -12)));
       (Asm.JmpCC (Asm.E, "cond_e2.6"));
       (Asm.Mov ((Asm.Imm 6), (Asm.Stack -24))); (Asm.Jmp "cond_end.5");
       (Asm.Label "cond_e2.6"); (Asm.Mov ((Asm.Imm 7), (Asm.Stack -24)));
