(Asm.Program
   Asm.Function {name = "main";
     ...
     [(Asm.AllocateStack 4); (Asm.Mov ((Asm.Imm 1), (Asm.Stack -4)));
       ...
       (Asm.JmpCC (Asm.E, "if_else.1")); (Asm.Jmp "label_expression");
       (Asm.Jmp "if_end.0"); (Asm.Label "if_else.1");
       (Asm.Jmp "label_empty"); (Asm.Label "if_end.0");
       (Asm.Label "label_goto"); (Asm.Jmp "label_return");
       (Asm.Mov ((Asm.Imm 0), (Asm.Reg Asm.R11)));
       (Asm.Cmp ((Asm.Imm 0), (Asm.Reg Asm.R11)));
       (Asm.JmpCC (Asm.E, "if_end.2")); (Asm.Label "label_expression");
