(Asm.Program
   Asm.Function {name = "main";
     ...
     [(Asm.AllocateStack 16); (Asm.Mov ((Asm.Imm 0), (Asm.Stack -4)));
       ...
       (Asm.Mov ((Asm.Imm 3), (Asm.Stack -4))); (Asm.Jmp "if_end.4");
       (Asm.Label "if_else.5"); (Asm.Mov ((Asm.Imm 8), (Asm.Reg Asm.AX)));
       Asm.Cdq; (Asm.Mov ((Asm.Imm 2), (Asm.Reg Asm.R10)));
       (Asm.Idiv (Asm.Reg Asm.R10));
       (Asm.Mov ((Asm.Reg Asm.AX), (Asm.Stack -16)));
       (Asm.Mov ((Asm.Stack -16), (Asm.Reg Asm.R10)));
       (Asm.Mov ((Asm.Reg Asm.R10), (Asm.Stack -4))); (Asm.Label "if_end.4");
       (Asm.Label "if_end.2"); (Asm.Mov ((Asm.Stack -4), (Asm.Reg Asm.AX)));
