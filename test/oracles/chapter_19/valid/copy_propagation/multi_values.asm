   ...
   [Asm.Function {name = "multi_path"; global = true;
     ...
     Asm.Function {name = "main"; global = true;
       ...
       [(Asm.AllocateStack 16); (Asm.Mov ((Asm.Imm 1), (Asm.Reg Asm.DI)));
         ...
         (Asm.Mov ((Asm.Imm 0), (Asm.Reg Asm.DI))); (Asm.Call "multi_path");
