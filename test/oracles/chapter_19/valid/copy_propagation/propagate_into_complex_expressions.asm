(Asm.Program
   [Asm.Function {name = "target"; global = true;
      ...
      [(Asm.AllocateStack 32); (Asm.Mov ((Asm.Imm 100), (Asm.Stack -4)));
        ...
        Asm.Binary {op = Asm.Add; src = (Asm.Imm 300); dst = (Asm.Stack -20)};
        (Asm.Mov ((Asm.Stack -20), (Asm.Reg Asm.R10)));
        (Asm.Mov ((Asm.Reg Asm.R10), (Asm.Stack -8)));
        (Asm.Cmp ((Asm.Imm 0), (Asm.Stack -20)));
        (Asm.JmpCC (Asm.E, "target.cond.el.5"));
        (Asm.Mov ((Asm.Imm 1), (Asm.Stack -28)));
        (Asm.Mov ((Asm.Stack -28), (Asm.Reg Asm.R10)));
        (Asm.Mov ((Asm.Reg Asm.R10), (Asm.Stack -24)));
        (Asm.Jmp "target.cond.en.4"); (Asm.Label "target.cond.el.5");
        (Asm.Mov ((Asm.Imm 25), (Asm.Stack -32)));
        (Asm.Mov ((Asm.Stack -32), (Asm.Reg Asm.R10)));
        (Asm.Mov ((Asm.Reg Asm.R10), (Asm.Stack -24)));
        (Asm.Label "target.cond.en.4");
