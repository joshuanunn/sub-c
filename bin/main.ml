let () =
  ...
  Subc.Io.with_input_file source_path (fun lexbuf ->
      ...
      | 4 -> Subc.Io.run_irgen lexbuf s_env t_env
      | 5 -> Subc.Io.run_codegen lexbuf s_env t_env
      | 6 -> Subc.Io.run_emit lexbuf s_env t_env
      | 7 -> Subc.Io.run_exe lexbuf target_path s_env t_env
      | _ ->
          prerr_endline
